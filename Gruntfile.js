		...
		*/
		grunt.initConfig({
			...
			uglify: {
				...
				build: {
					files:  {},
					src:    'bootstrap-dualselect.js',
					dest:   'bootstrap-dualselect.min.js'
				}
			},
			less: {
				development: {
					...
					files: {
						"main.css": "_base.less",
						"bootstrap-dualselect.css": "_bootstrap-dualselect.less"
					}
				}
			},
			cssmin: {
				dev: {
					src: ['bootstrap-dualselect.css'],
					dest: 'bootstrap-dualselect.min.css'
				}
			}/*,
			karma: {
				unit: {
